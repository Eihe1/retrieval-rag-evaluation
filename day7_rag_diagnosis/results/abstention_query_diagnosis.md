# Query-level Diagnosis: Abstention RAG
...
- Faithfulness: 1.000
- Citation relevance: 0.000
- Failure type: `over_conservative_abstention`

Diagnosis: The system abstains even though the gold document is retrieved. This indicates that the evidence sufficiency check is too conservative or the evidence selector fails to recognize the correct evidence.
...
- Faithfulness: 1.000
- Citation relevance: 0.000
- Failure type: `correct_abstention`

Diagnosis: The system correctly avoids answering when evidence is insufficient.
